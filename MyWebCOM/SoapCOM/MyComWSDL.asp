...
Dim SoapServer
If Not Application("MyComWSDLInitialized") Then
  Application.Lock
  If Not Application("MyComWSDLInitialized") Then
    Dim WSDLFilePath
    Dim WSMLFilePath
    WSDLFilePath = Server.MapPath("MyComWSDL.wsdl")
    WSMLFilePath = Server.MapPath("MyComWSDL.wsml")
    ...
    Set Application("MyComWSDLServer") = SoapServer
    Application("MyComWSDLInitialized") = True
  End If
  Application.UnLock
End If
Set SoapServer = Application("MyComWSDLServer")
